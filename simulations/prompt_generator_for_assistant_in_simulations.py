def prompt_generator(where, when, who_what, memory_block):
    ...
    if memory_block is None:
        ...
        system_prompt = f"""
            ...
            {who_what}.  
            Please behave like a helpful family member who gently initiates a conversation with me based on this context. Keep each response very simple, concise and straightforward.
            """
    else:
